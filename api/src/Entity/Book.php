...
// todo add custom filter by average rating
class Book
{
    /**
    ...
    #[ApiProperty(
        ...
        example: 'https://openlibrary.org/books/OL28346544M.json'
    )]
    ...
    #[Groups(groups: ['Book:read', 'Book:read:admin', 'Bookmark:read', 'Bookmark:read:admin', 'Review:read:admin'])]
